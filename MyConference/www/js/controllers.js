...
//Function for sending file to the users email address
   ...
   */
  .controller('EditAgendaCtrl', function ($scope, $state, $stateParams, backendService, $ionicPlatform, $ionicLoading, $ionicPopup, $cordovaInAppBrowser, $translate, $timeout) {
    backendService.getAgendaById($stateParams.agendaId).then(function (res) {
      $scope.agenda = res['data'];
    })
    /*
  ...
  .controller('EditAccountCtrl', function ($scope, $state, backendService, $ionicPopup, $translate, $ionicLoading, $timeout) {
    ...
    $scope.updateAccount = function (user) {
      ...
      backendService.updateUserProfile({
  ...
  .controller('ContactCtrl', function ($scope, $cordovaEmailComposer, 4translate, backendService) {
